...
+ (BOOL)ghostReadReceiptEnabled {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"ghost_read_receipt"];
}
+ (BOOL)ghostProfileViewEnabled {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"ghost_profile_view"];
}
+ (BOOL)ghostOnlineStatusEnabled {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"ghost_online_status"];
}
+ (BOOL)ghostTypingEnabled {
